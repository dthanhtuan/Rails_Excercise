...
ActiveRecord::Schema.define(version: 20180314072106) do
  ...
  create_table "developer_programming_languages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["developer_id", "programming_language_id"], name: "index_dev_programing", unique: true
    t.index ["developer_id"], name: "dev_dev_pro_lang"
    t.index ["programming_language_id"], name: "pro_lang_dev_pro_lang"
  end
  ...
  create_table "programming_languages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_programming_languages", unique: true
  end
